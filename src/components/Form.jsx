  ...
  const handleCourseChange = async (e) => {
    ...
    try {
      const res = await axios.post(
        ...
        { school_code: "1009", course_id: courseId, campus: "nashik", year: "2026" }
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.data.status || res.data.success) {
        ...
        setTimeout(() => {
          window.location.href = "https://www.sandipuniversity.edu.in/thankyou-design.php";
        }, 1500);
      } else {
...
<div class="npf_wgts" data-height="500px" data-w="f2c97c5bc9bbc30761df69f25c3d58f1"></div>
